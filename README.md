...
Platform web HMTI Cikarang: profile organisasi, katalog program kerja,
forum aspirasi mahasiswa, sistem Open Recruitment (Oprec) dan generator PDF & QR Code otomatis,
serta admin dashboard untuk pengelolaan.
